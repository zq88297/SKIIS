...
| 触发条件 | 汇报内容 |
|---------|---------|
| 对话超过 **15 轮** | 完整健康报告（估算 token 消耗、剩余轮次、建议） |
| 对话超过 **25 轮** | 🟡 黄色预警，强烈建议保存后开新会话 |
| AI 发现自身回复矛盾 | 🔴 立即警告：上下文可能已不完整 |
| 对变量名/文件路径不确定 | 🟡 提醒：核心上下文可能在压缩中丢失 |
| 开始重复之前的建议 | 🟡 提醒：可能进入了循环回复模式 |
| 用户纠正 AI 超过 2 次 | 🔴 警告：建议立即保存 + 新会话 |
...
🪙 Token: [████░░] ~60% | 预计还能 15-20 轮
🧠 质量: ⚠️ 轻微衰减（最近 3 轮回复变模糊）
🎯 幻觉: 🟢 低风险
